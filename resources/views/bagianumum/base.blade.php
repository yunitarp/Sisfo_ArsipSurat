<?php
  if(Session::has('role') and Session::get('role') != 'karyawan'){
    ...
    header('Location:'.url('/karyawan'));die();
  }
?>
<!DOCTYPE html>
<html>
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{url('kp')}}dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{url('kp')}}/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Anggota Sejak {{{{Session::get('username')->tgl_masuk}}}}</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{url('bagianumum/inputsuratmasuk')}}"><i class="fa fa-circle-o"></i>Entri Baru</a></li>
            <li><a href="{{url('bagianumum/lihatsuratmasuk')}}"><i class="fa fa-circle-o"></i>Data Surat Masuk</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>SURAT KELUAR</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="{{url('bagianumum/inputsuratkeluar')}}"><i class="fa fa-circle-o"></i>Entri Baru</a></li>
            <li><a href="{{url('bagianumum/lihatsuratkeluar')}}"><i class="fa fa-circle-o"></i>Data Surat Keluar</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{url('bagianumum/laporansurat')}}"><i class="fa fa-circle-o"></i>Laporan Surat Masuk</a></li>
            <li><a href="{{url('bagianumum/laporansurat')}}"><i class="fa fa-circle-o"></i>Laporan Surat Keluar</a></li>
          </ul>
        </li> 
    </section>
    <!-- /.sidebar -->
