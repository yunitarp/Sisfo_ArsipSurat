	...
	@section('content')
	    ...
	    <section class="content-header">
	      ...
	      <ol class="breadcrumb">
	        ...
	        <li class="">Laporan</li>
	        <li class="active">Laporan Surat Masuk dan Keluar</li>
	      </ol>
	    </section>
	    <!-- Main content -->
      ...
      <div class="row">
        ...
        <div class="box box-primary">
            <div class="box-header">
                <center><h3 class="box-title">Laporan Surat Masuk dan Keluar</h3></center>
            </div>
...
<script>
  var isiTanggal = function(obj){
     document.location.href = "{{url('/laporansurat')}}/"+obj.val()
  }
  ...
  $('#daterange-btn').daterangepicker(
        ...
        function (start, end) {
          document.location.href = "{{url('/laporansurat').'/'}}"+start.format('YYYY-MM-DD') + '/' + end.format('YYYY-MM-DD');
